...
function Main(props) {
    ...
    return (
        <div>
            ...
            <Card style={{ width: "100%", height: "12cm", marginTop: "3%", marginLeft: "20px" }}>
                <CardContent style={{ textAlign: "center" }} >
               <div>
                <button style={{ backgroundColor: "#00aae7",position:"absolute",left:"35px"}} onClick={backbutton}><ArrowBackIcon/></button>
               </div>
                    <Table style={{ width: "95%", height: "5cm", marginLeft: "40px", backgroundColor: "#00aae7" }}>
                        ...
                        <tbody >
                            <tr style={{ position: "absolute", right: "05px", top: "80px" }}>
                                <td style={{ position: "absolute", right: "1340px", fontWeight: "bold"  }}>Total(Hrs)</td>
                    ...
                    <br></br>
                    <button style={{ position: "absolute", left: "1400px", bottom: "200px",backgroundColor: "#00aae7" }}  onClick={handleSubmit} >submit</button>
                    {/* <div>
                        <h1>value:{props.value}</h1>
                    </div> */}
                    <div style={{position:'absolute', bottom:"140px",right:"200px"}}>
                    <h4>TotalSum:{values.sum} </h4>
                    </div>
                </CardContent>
            </Card>
        </div>
